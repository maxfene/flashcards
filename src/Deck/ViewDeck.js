...
//retrieves current deck using deckId from params
  useEffect(() => {
...
//on delete, window prompt appears for double-check; if confirmed, nagivate home.
...
//returns deck information only when deck.id is loaded
  return (
    <div>
